...
function SampleNextArrow(props) {
  const {  onClick } = props;
  return <div onClick={onClick} className='absolute top-[50%] left-0  text-white cursor-pointer'>
...
function SamplePrevArrow(props) {
  ...
  const {  onClick } = props;
  return <div onClick={onClick} className='absolute top-[50%] right-0 z-10 text-white cursor-pointer'>
...
export const Hero = () => {
  ...
  return (
    ...
    <div className='w-full h-full md:w-1/2 grid grid-cols-2 sm:grid-cols-2'>
    {hero2.map((item) =>(
