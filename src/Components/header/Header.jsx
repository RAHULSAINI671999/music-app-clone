    ...
    <header className='fixed top-0 left-0 z-50 w-screen h-[8vh] md:shadow-md shadow-sm bg-white'>
      ...
      <div className='hidden md:flex justify-between px-7 p-2'>
        ...
        <div className='logo flex'>
          <div>
            <img src='https://raw.githubusercontent.com/sunil9813/Music-App-/master/src/components/assets/images/logo.png' alt='logo' width='40px' height='40px' />
          </div>
        ...
        <div className='profile flex items-center'>
          ...
          <div className='img w-10 h-10 rounded-full'>
            <img src='https://github.com/sunil9813/Music-App-/blob/master/src/components/assets/images/b4.jpg?raw=true' alt='profile' className='img w-10 h-10 bg-red-300 rounded-full object-cover cursor-pointer' />
          </div>
        </div>
      </div>
